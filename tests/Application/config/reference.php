 ...
 * }
 * @psalm-type XutimAnalyticsConfig = array{
 *     site_host?: scalar|Param|null, // The site host for internal/external referrer detection. Falls back to Request::getHost() if not set. // Default: null
 *     models?: array<string, array{ // Default: []
 *         class?: scalar|Param|null, // The FQCN of the concrete entity class used by the application, extending the bundle's base entity.
 *     }>,
 *     message_routing?: array<string, scalar|Param|null>,
 * }
 * @psalm-type XutimCoreConfig = array{
 *     models?: array<string, array{ // Default: {"block_item":{"class":"Xutim\\CoreBundle\\Entity\\BlockItem"},"block":{"class":"Xutim\\CoreBundle\\Entity\\Block"},"tag":{"class":"Xutim\\CoreBundle\\Entity\\Tag"},"content_translation":{"class":"Xutim\\CoreBundle\\Entity\\ContentTranslation"},"log_event":{"class":"Xutim\\CoreBundle\\Entity\\LogEvent"},"article":{"class":"Xutim\\CoreBundle\\Entity\\Article"},"page":{"class":"Xutim\\CoreBundle\\Entity\\Page"},"menu_item":{"class":"Xutim\\CoreBundle\\Entity\\MenuItem"},"site":{"class":"Xutim\\CoreBundle\\Entity\\Site"},"tag_translation":{"class":"Xutim\\CoreBundle\\Entity\\TagTranslation"},"content_draft":{"class":"Xutim\\CoreBundle\\Entity\\ContentDraft"}}
 *         class?: scalar|Param|null, // The FQCN of the concrete entity class used by the application, extending the bundle's base entity.
 *     }>,
 *     message_routing?: array<string, scalar|Param|null>,
 * }
 * @psalm-type XutimNotificationConfig = array{
 *     models?: array<string, array{ // Default: {"notification":{"class":"Xutim\\NotificationBundle\\Entity\\Notification"}}
 *         class?: scalar|Param|null, // The FQCN of the concrete entity class used by the application, extending the bundle's base entity.
 *     }>,
 *     message_routing?: array<string, scalar|Param|null>,
 * }
 * @psalm-type XutimEventConfig = array{
 *     models?: array<string, array{ // Default: []
 *         class?: scalar|Param|null, // The FQCN of the concrete entity class used by the application, extending the bundle's base entity.
 *     }>,
 * }
 * @psalm-type XutimMediaConfig = array{
 *     models?: array<string, array{ // Default: []
 *         class?: scalar|Param|null,
 *     }>,
 *     storage?: array{
 *         public_dir?: scalar|Param|null, // Default: "%kernel.project_dir%/public"
 *         media_path?: scalar|Param|null, // Default: "media"
 *         url_prefix?: scalar|Param|null, // Default: "/media"
 *     },
 *     processing?: array{
 *         driver?: "imagick"|"gd"|"vips"|Param, // Default: "imagick"
 *         optimize?: bool|Param, // Default: true
 *     },
 *     presets?: array<string, array{ // Default: []
 *         max_width?: int|Param,
 *         max_height?: int|Param,
 *         fit_mode?: "cover"|"contain"|"scale"|Param, // Default: "cover"
 *         quality?: array<string, int|Param>,
 *         use_focal_point?: bool|Param, // Default: true
 *         formats?: list<scalar|Param|null>,
 *         responsive_widths?: list<int|Param>,
 *     }>,
 * }
 * @psalm-type XutimRedirectConfig = array{
 *     models?: array<string, array{ // Default: []
 *         class?: scalar|Param|null, // The FQCN of the concrete entity class used by the application, extending the bundle's base entity.
 *     }>,
 * }
 * @psalm-type XutimSecurityConfig = array{
 *     models?: array<string, array{ // Default: []
 *         class?: scalar|Param|null, // The FQCN of the concrete entity class used by the application, extending the bundle's base entity.
 *     }>,
 * }
 * @psalm-type XutimSnippetConfig = array{
 *     models?: array<string, array{ // Default: []
 *         class?: scalar|Param|null, // The FQCN of the concrete entity class used by the application, extending the bundle's base entity.
 *     }>,
 * }
 ...
 *     xutim_analytics?: XutimAnalyticsConfig,
 *     xutim_core?: XutimCoreConfig,
 *     xutim_notification?: XutimNotificationConfig,
 *     xutim_event?: XutimEventConfig,
 *     xutim_media?: XutimMediaConfig,
 *     xutim_redirect?: XutimRedirectConfig,
 *     xutim_security?: XutimSecurityConfig,
 *     xutim_snippet?: XutimSnippetConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
