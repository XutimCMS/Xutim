...
class Button
{
    ...
    public function getVariantClasses(): string
    {
        return match ($this->variant) {
            ...
            'nav' => 'flex items-center gap-2 whitespace-nowrap rounded-md px-2.5 py-1.5 text-[13px] font-medium text-content-secondary hover:bg-surface-raised hover:text-content transition-colors',
