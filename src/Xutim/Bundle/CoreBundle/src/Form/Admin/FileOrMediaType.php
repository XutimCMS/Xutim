...
/**
 * @extends AbstractType<array{new_file: ?UploadedFile, existing_file: ?File, name: ?string, alt: ?string, locale: ?string}>
 */
class FileOrMediaType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            //
                // ])
                //  ->addDependent('existing_file', 'new_file', function (DependentField $field, ?UploadedFile $newFile){
            //       dump($newFile);
            //       if ($newFile === null){
            ...
            //       }
                // })
                // ->addDependent('name', 'new_file', function (DependentField $field, ?UploadedFile $newFile){
            //     if ($newFile !== null){
            ...
            //     }
                // })
            //
                // ->addDependent('alt', 'new_file', function (DependentField $field, ?UploadedFile $newFile){
            //     if ($newFile !== null){
            //         $field->add(TextType::class, [
            //             'label' => new TranslatableMessage('Alternative text', [], 'admin'),
            //             'help' => new TranslatableMessage('Leave empty if the image is purely decorative.', [], 'admin'),
            ...
            //     }
                // })
            //
                // ->addDependent('language', 'new_file', function (DependentField $field, ?UploadedFile $newFile) use ($locales){
            //     if ($newFile !== null){
