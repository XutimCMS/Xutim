...
import SidebarToggle from './controllers/sidebar-toggle_controller.js';
import Dropdown from './controllers/dropdown_controller.js';
import LocaleDropdown from './controllers/locale-dropdown_controller.js';
import Tab from './controllers/tab_controller.js';
app.register('sidebar', Sidebar);
app.register('dropdown', Dropdown);
app.register('tab', Tab);
app.register('sidebar-toggle', SidebarToggle);
...
app.register('locale-dropdown', LocaleDropdown);
